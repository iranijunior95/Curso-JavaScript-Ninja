...
var teams = ['Flamengo', 'Fluminense', 'Vasco', 'Palmeiras', 'Bota Fogo'];
...
function convertToHex(cor) {
    ...
    switch (cor) {
        case "azul":
            return `O hexadecimal para a cor ${cor} é #000080.`;
            break;
        ...
        case "violeta":
            return `O hexadecimal para a cor ${cor} é #8B008B.`;
            break;
