...
var name = ['jo', 'se', 'ira', 'ni'];

var n = name.reduce(function(acumulado, atual, index, array){

    return acumulado + atual+'p';
}, 'p');

console.log( '\nSeu nome na língua do "P": '+n );
// ?
...
if(numberObjects.indexOf(2).number > 0) {
...
if(numberObjects.lastIndexOf(2).number > 0) {
    console.log("Existe um objeto { number: 2 } em numberObjects!");
}else {
    console.log("Não existe um objeto { number: 2 } em numberObjects :(");
}
