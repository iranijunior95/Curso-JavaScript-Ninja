...
chamada.
*/
console.log( 'O resultado da subtração é:' +subtraction((num1, num2)=>{ return num1 - num2; }));
// ?

console.log( 'O resultado da multiplicação é:' +multiplication((num1, num2) => { return num1 * num2; }));
// ?

console.log( 'O resultado da divisão é:' +division((num1, num2) => { return num1 / num2; }));
// ?

console.log( 'O resto da divisão é:' +mod((num1, num2) => { return num1 % num2 }));
// ?
